...
class LcdDisplay {
   public:
       ...
       */
      //---------------------------------------------------
      void displayStringAtPosition(const char* pData, char szLine, char szCol =
            0);
       ...
       */
      //---------------------------------------------------
      void setCursorAtPosition(char szLine, char szCol, bool isVisible,
            bool isBlinking);
