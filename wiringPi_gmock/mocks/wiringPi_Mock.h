...
class MockWiringPi{
 public:
   ...
   // Core wiringPi functions
   MOCK_METHOD1(wiringPiFindNode,  struct wiringPiNodeStruct *(int pin));
   MOCK_METHOD2(wiringPiNewNode,   struct wiringPiNodeStruct *(int pinBase, int numPins));
